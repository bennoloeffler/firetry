...
```shadow-cljs watch app browser-test```
...
* [`src/firetry/`](src/firetry/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/firetry/core.cljs): contains the SPA entry point, `init`
* [`test/firetry/`](test/firetry/): test files (ClojureScript,
...
5. Clone this repo and open a terminal in the `firetry` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/firetry/config.cljs) defaults to `true` in
...
```clj
(ns firetry.example
  (:require [firetry.config :as config])
